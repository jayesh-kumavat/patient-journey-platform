...
from sqlalchemy import create_engine, MetaData, Table, Column, String, Float, Integer, Date, Text, Numeric
...
def create_anomaly_table(engine):
    ...
    Table("anomaly_results", metadata,
        ...
        Column("avg_quantity", Numeric(10, 2)),
        Column("max_quantity", Integer),
        Column("unique_patients", Integer),
        Column("detection_date", Date),
