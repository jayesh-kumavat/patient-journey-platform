...
VALID_THERAPIES = {"Oncology", "Cardiology", "Neurology", "Immunology", "Diabetes", "Respiratory"}
...
def build_filters(selected_region, selected_therapy):
    ...
    if selected_region != "All" and selected_region in VALID_REGIONS:
        conditions.append("p.region = :region")
        params["region"] = selected_region

    if selected_therapy != "All" and selected_therapy in VALID_THERAPIES:
    ...
    return {
        ...
        "params": params,
        "therapy_filter": "AND fp.therapy_area = :therapy" if selected_therapy in VALID_THERAPIES else "",
        "ts_therapy_filter": "AND ts.therapy_area = :therapy" if selected_therapy in VALID_THERAPIES else "",
    }
