...
| amount | DECIMAL(10,2) | Claim dollar amount ($50 - $15,000 typical range) | |
...
| is_current | INTEGER | Flag indicating if this is the active record (1=yes, 0=no) | Default: 1 |
...
| anomaly_score | FLOAT | Isolation Forest decision function score (lower = more anomalous) | |
...
| avg_quantity | FLOAT | Average quantity per prescription | |
...
| confidence | FLOAT | Normalized confidence score (0-1, higher = more confident) | |
...
| overall_score | FLOAT | Ratio of passed/total (0.0 to 1.0) | |
